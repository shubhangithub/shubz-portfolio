// Site palette tokens. The live palette is the V5 "field notebook × terminal"
// system below (NB_LIGHT / NB_DARK / nbTheme). The old flat V4 Palette was
// removed with the V4 app.
