...
export const WORK_EVENTS: WorkEvent[] = [
  ...
  { year: "Sep 2022 – May 2023",     what: "BSc Honours Thesis · GNSS atmospheric water vapour",                          where: "FLAME · Prof. Gopalan", note: "Estimated tropospheric water-vapour content from GNSS signals using regression-based ML models, outperforming traditional linear baselines on accuracy and robustness to atmospheric variability. The thesis that closed out the degree." },
  ...
  { year: "May 2023",                what: "BSc (Hons) Computer Science · Dean's Roll of Honour · FLAME University",      where: "CGPA 8.53",         note: "Graduated ranked 3rd in cohort (from 41st in year one). Three years of learning how to work." },
...
export const WORK_BUILDS: WorkBuild[] = [
  ...
  { name: "this site",                          c: "yellow",  scope: "open",                  year: "2026",   essay: null,              url: "https://github.com/shubhangithub/personal-site",                        blurb: "Started as a single-file HTML + CSS + inline React app; migrated to Astro during the astro-migration branch. Essays, animated diagrams, and an unreasonable amount of time spent on typography." },
];
