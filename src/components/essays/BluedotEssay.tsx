  ...
  return (
    <>
      ...
      <p className="drop-cap" style={{ fontSize: "1.18rem", lineHeight: 1.72, margin: "0 0 1.2rem" }}>
        Throughout 'Machines of Loving Grace,' Dario Amodei's October 2024 essay on what powerful AI might produce, the word 'we' seems to do three distinct jobs simultaneously.<span className="sidenote-number" style={{ color: p.accent }}>1</span> 'We will be able to cure most infectious diseases' is one scope. 'We will need to fight for this outcome against those who would concentrate power' is another. The lab's own voice, which is bounded and specific, is a third. The gap between the civilisational 'we' and the actual room where AI decisions get made is the unit's central question, and is not named directly.
      ...
      <p>The RAND paper targets MAIM — Mutual Assured AI Malfunction — the proposal that states should deter AI monopoly bids via the credible threat of preventive infrastructure sabotage. RAND endorses the two less aggressive pillars of the underlying proposal (nonproliferation and managed competition) and attacks only the third. </p>
      ...
      <p>The diagram below is a map of the current state.</p>
