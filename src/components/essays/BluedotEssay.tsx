  ...
  return (
    <>
      ...
      <p className="drop-cap" style={{ fontSize: "1.18rem", lineHeight: 1.72, margin: "0 0 1.2rem" }}>
        Throughout 'Machines of Loving Grace' — Dario Amodei's October 2024 essay on what powerful AI might produce — the word 'we' does three distinct jobs simultaneously, without announcing which one it's doing.<span className="sidenote-number" style={{ color: p.accent }}>1</span> 'We will be able to cure most infectious diseases' is one scope. 'We will need to fight for this outcome against those who would concentrate power' is another. The lab's own voice — bounded and specific — is a third. The slippage is not careless. It is the problem. The gap between the civilisational 'we' and the actual room where AI decisions get made is the unit's central question, and almost no paper in it names it directly.
      ...
      <p>This essay is an attempt to answer one question: what would it actually take to shape AI's future toward the good outcome? BlueDot Impact's AGI Strategy cohort assigned nine readings to that question — five mandatory, four optional. Taken together, they are not a debate so much as a set of partial answers to the same problem, talking past each other in ways the unit doesn't flag. I'll work through six constraints, in order. Each one makes the answer harder and more specific. The last one is: who, exactly, is the 'we' in all of this?</p>
      ...
      <p>Start with what makes the question worth asking. 'Machines of Loving Grace' is the most expansive, carefully-argued optimistic vision any frontier lab author has published. Its central claim: if alignment is solved, powerful AI compresses decades of progress in biology, mental health, economic development, and geopolitics into a much shorter window. Not 'AI will be useful' — that's already true — but something structurally different: a 'country of geniuses in a datacenter,' running at ten to a hundred times human speed, taking on the problems that have resisted human intelligence for generations.</p>

      <p>The framework Amodei uses to make this claim is the most useful analytical tool in any of the unit's readings. He calls it marginal returns to intelligence: for any task, ask how much faster it would go with vastly more intelligence, holding everything else constant. The answer varies enormously by domain. Writing code is highly intelligence-bottlenecked — almost all the constraints are cognitive, and better reasoning produces better code almost directly. Drug discovery is intelligence-bottlenecked in its early stages (hypothesis generation, target identification, experimental design) but time-bottlenecked in its later stages, where Phase I, II, and III trials run on human biology that cannot be parallelised beyond the population willing to participate. Building democratic institutions is barely intelligence-bottlenecked at all: we know quite well what good institutions look like; the bottleneck is political will, historical contingency, and coordination problems that accumulate over decades.</p>

      <p>This distinction — between intelligence bottlenecks and everything else — is the right tool for evaluating the grand claims. 'AI will transform biology' needs to be evaluated differently from 'AI will transform geopolitics,' because biology and geopolitics are differently bottlenecked. 'AI will double human lifespan' hits the clinical-trial constraint almost immediately: no amount of intelligence shortens the time it takes to run a ten-year longevity trial, because the biology is the experiment and it runs in real time.<span className="sidenote-number" style={{ color: p.accent }}>2</span>
        <span className="sidenote">
      ...
      <p>The diagram is not an argument against the vision. It is a way of taking the vision seriously enough to ask which parts of it are actually delivered by more intelligence and which parts require different inputs entirely. Drug discovery and mental health are substantially intelligence-bottlenecked in their early stages — real wins, real acceleration. Economic development and geopolitics are mostly not. The honest version of the prize is domain-specific: powerful AI delivers enormously in some areas and relatively little in others, depending on what is actually in the way. That specificity makes the prize more defensible, not less. The prize is real. Now the question is what stands between here and there.</p>
      ...
      <p>None of these is wrong, exactly. A multilateral dialogue can coexist with domestic regulation and reformed lab governance. But they compete for political bandwidth, institutional energy, and the authority to set the terms — and there is a deeper problem underneath, which Samuel names more precisely than the others. The structural pressure on safety-first commitments isn't a product of bad intentions. It's a product of competitive dynamics, capital dependency, and regulatory ambiguity — forces that operate regardless of what a given lab believes or says. Any governance answer that relies on voluntary commitment has to explain why the structure won't erode it.</p>
      ...
      <p>That reframing matters. The question isn't whether AI is good or bad in the abstract — it's: given that powerful AI is coming, which capabilities should arrive first? The answer depends on the 'jagged frontier' — the observation that AI advances unevenly across domains. It has advanced enormously in language and code generation; substantially in protein structure prediction; less in reasoning about physical systems; relatively little in autonomous multi-day task completion in complex real-world environments. At any given moment, the frontier is jagged, and the shape of that edge determines what is and isn't possible to shape. Combine this with the marginal-returns framework from §01 and you get a specific policy agenda: accelerate in domains that are intelligence-bottlenecked and defensively oriented; proceed cautiously in domains that are intelligence-bottlenecked and offensively oriented. Cybersecurity is roughly symmetric — AI can help defence about as much as offence. Biology is not: at the frontier, AI-assisted biodesign poses near-term offensive risks that biodefence infrastructure isn't yet equipped to match.</p>

      <p>IFP names three historical playbooks for how this kind of deliberate shaping has been done before:</p>

      <ol style={{ margin: "1.2rem 0", paddingLeft: "1.4rem", lineHeight: 1.7 }}>
        <li><strong>Nonproliferation</strong> (nuclear weapons): restrict access to dangerous capabilities from the outset via export controls and international treaty regimes. In AI terms: compute and chip export controls, TSMC and ASML dependencies the US currently holds.</li>
      ...
      <p>What makes this valuable is the historical specificity. IFP isn't arguing from first principles that shaping is possible — it's showing that the US has done it before, in three different modes, with different policy instruments. The case studies pull the 'can we shape this?' debate out of pure hypothetical and into documented precedent. The limiting assumption is that 'US shaping' and 'good shaping' are the same thing. The mechanisms IFP wants to use — compute restrictions, supply-chain leverage, export controls — concentrate decision-making authority in whichever executive branch is in office. The governance of the shaping mechanism is itself an open problem, not a solved one. The mechanism exists and has historical precedent. But it runs into a harder problem at scale.</p>
      ...
      <p>Rutger Bregman's chapter from <em>Utopia for Realists</em> looks like the odd one out in this unit. It is about whether affluent societies can still imagine a better future — not about AI strategy specifically. But it introduces a distinction that turns out to be the most useful analytical lens for reading the vision essays, and for understanding why the geopolitical complications in §04 are harder than they look.</p>
      ...
      <p>Here is what I take from working through all nine readings in order. The prize is real and specific: the marginal-returns framework tells us exactly which parts of the vision are actually delivered by more intelligence, and enough of them are that the question is worth pursuing seriously. The structural obstacle is real: markets won't get there, and voluntary commitments face predictable pressure. The mechanism exists: IFP's three historical playbooks show that deliberate shaping has happened before, and the path-dependence argument tells us why the build order matters as much as the eventual capability set. The international complication is real and underexplored: the most ambitious geopolitical strategies in the unit share structural features that RAND's critique applies to, and the two papers don't know they're talking about the same problem. The vision question is real: blueprint mode is motivating but brittle, and the guidepost alternative — Toner's dynamism, Bregman's directional hope — is harder to hold but more likely to survive contact with the actual path.</p>
