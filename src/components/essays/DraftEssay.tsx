...
export function DraftEssay({ post, palette: p, onNavigate }) {
  return (
    <>
      ...
      <p style={{ fontSize: "1.06rem", lineHeight: 1.7, color: p.ink, padding: "1.4rem 1.6rem", borderLeft: `2px solid ${p.accent}`, background: `color-mix(in srgb, ${p.paper} 75%, ${p.ink})`, margin: "1.4rem 0" }}>
        {post.dek}
      </p>
