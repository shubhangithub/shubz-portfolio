...
export function WorkV4({ palette: p, onNavigate, setCursorColor, dark, toggleTheme }) {
  ...
  const events = [
    { year: "2026 —", what: "Elected MInstP · Institute of Physics", where: "London · Feb 2026", note: "The UK's professional body for physics, elected route. The certificate is small and unreasonably satisfying." },
  ...
  const builds = [
    ...
    { name: "Nand2Tetris — 16-bit computer", scope: "coursework", role: "Built a working general-purpose computer from NAND gates up: all 13 projects from HDL gate design through machine language, VM translator, compiler, and a minimal operating system. One of the cleaner things I've done.", year: "2022" },
    { name: "this site", scope: "open", role: "Started as a single-file HTML + CSS + inline React app; migrated to Astro during the astro-migration branch. Essays, animated diagrams, and an unreasonable amount of time spent on typography.", year: "2026", url: "https://github.com/Shubzthub/personal-site" },
  ];
