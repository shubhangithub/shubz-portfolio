...
import { BluedotEssay, ConstraintClusterEssay, DraftEssay, FashionEssay, FourierMotif, IndexRail, JayaEssay, LetterReveal, MayEssay, POSTS, PreciseFooter, PreciseNav, PreciseTopBar, ReadingRuler, SixEnginesEssay, TerminalPanel, ThresholdEssay, TuringEssay, ZXEssay, essayMeta, useIsMobile, usePreciseScroll, useTelemetry } from '../legacy';
      ...
      <header style={{ maxWidth: 1280, margin: "0 auto", padding: "3rem 1.6rem 1rem", position: "relative", zIndex: 2 }}>
        <div className="v4-grid" style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: "1.6rem", alignItems: "end" }}>
          ...
          <div style={{ gridColumn: "10 / span 3", paddingBottom: "0.6rem" }}>
            <div style={{ border: `1px solid ${p.line}`, padding: "0.8rem", aspectRatio: "1 / 1", display: "grid", placeItems: "center", background: `color-mix(in srgb, ${p.paper} 85%, ${p.ink})` }}>
          ...
          <div style={{ gridColumn: "3 / span 7" }}>
            {(() => {
              switch (post.slug) {
                ...
                case "turing-morphogenesis": return <TuringEssay palette={p} />;
